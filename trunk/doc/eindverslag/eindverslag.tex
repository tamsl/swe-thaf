...
De mapmaker maakt gebruik van tinySLAM een bibliotheek voor SLAM die te vinden is op \hyperef{www.openslam.org}. Hier hebben we een python versie van gevonden. Hoe deze python bibliotheek werkt is. Elke keer dat je de map wilt
updaten moet je de methode \verb!makeMap! aan te roepen. De laser waardes kunnen direct meegegeven worden aan deze methode, maar de positie die je van de
odometry mee krijgt moeten eerst worden getransformeerd naar het midden van de 
het plaatje. Ook wordt de theta van de odometry ogezet van radialen naar graden. In de \verb!makeMap! methode wordt voor elke laserstralen een beetje aan gepast en daarna de \verb!ts_map-update! aangeroepen die vervolgens
