...
De library comunicator leest een bestand in wat de locaties van de modules bevat. Via deze data maakt hij connecties aan met andere modules. De communicator library importeerd 2 thread klasses en een derde klasse. De ene thread luistert naar de gemaakte connecties en de andere luistert naar een poort of er nieuwe connecties gemaakt moeten worden. De thread die luistert handelt de berichten af volgens ons communicatieprotocol. Hierin staan alle mogelijke berichten en tags die gebruikt worden bij onze communicatie en wat hun doel is. Hierna handelt elke module zijn ontvangen data anders af.
