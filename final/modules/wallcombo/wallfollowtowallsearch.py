...
def wallfollow(min_val, index_val, length):
    ...
    print "I'm now following a wall."
                ...
                if len(datasplit) > 6:
                    ...
                    if min_val <= level:
                        ...
                        if min_val <= 0.30:
                            ...
                            print "I'm too close to the wall, I will adjust."
                        ...
                        if min_val >= 0.38 and min_val <= 0.4:
                            print "I'm too far away from the wall, I will adjust."
                            if index_val > length/2:
                                print "Adjust to the right."
                                s.send(handle_movement("left", -1.0, 1.0))
                                side = 0
